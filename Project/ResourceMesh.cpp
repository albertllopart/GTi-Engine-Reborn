...
void Mesh::CreateVBO()
{
	...
	glBufferData(GL_ARRAY_BUFFER, sizeof(float) * vertex_num * 3, vertex_info, GL_STATIC_DRAW);
...
void Mesh::CreateIBO()
{
	...
	glBufferData(GL_ELEMENT_ARRAY_BUFFER, sizeof(uint) * index_num, index_info, GL_STATIC_DRAW);
